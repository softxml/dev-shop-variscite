...
if (!class_exists('MCProtectFWRuleEngine_V555')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V555 {
	use MCProtectFWRuleStringFunc_V555;
	use MCProtectFWRuleArrayFunc_V555;
	use MCProtectFWRuleMiscFunc_V555;
	use MCProtectFWRuleRequestFunc_V555;
	use MCProtectFWRuleWPFunc_V555;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V555::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V555 $e) {
			$this->error = $e;
		}
	}
